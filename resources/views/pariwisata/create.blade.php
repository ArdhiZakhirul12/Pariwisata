...
@section('container')
    ...
    <div class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Membuat Pariwisata Baru</h1>
      </div>
      <div class="d-flex justify-content-center" >
      <div class="col-lg-8">
      <form method="post" action="/pariwisata" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
          <label for="nama_tempat" class="form-label"><h5>Tempat Pariwisata</h5></label>        
          <input type="text" class="form-control @error('nama_tempat') is-invalid @enderror" id="nama_tempat" name="nama_tempat" required autofocus value="{{ old('nama_tempat') }}">
          @error('nama_tempat')
        ...
        <div class="mb-3">
          ...
          <textarea type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" required value="{{ old('alamat') }}"></textarea>
          @error('alamat')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
